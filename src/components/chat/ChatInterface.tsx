...
import { Send, Bot, User, FileText, Github, HardDrive, Settings, AlertCircle, Sparkles, BrainCircuit, FolderKanban, ShieldCheck } from 'lucide-react';
...
import { parseWoodRequest, WoodUnitSpec } from '@/lib/wood-unit-parser';
